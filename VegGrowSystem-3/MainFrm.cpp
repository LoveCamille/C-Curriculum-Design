...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	CRect rect;
	GetClientRect(&rect);
	if (!m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CDisplayView), CSize(350, rect.Height()), pContext) ||
		!m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CSearchView), CSize(rect.Width() - 350, rect.Height()), pContext))
	{
...
void CMainFrame::OnSize(UINT nType, int cx, int cy)
{
	...
	if (m_rectInit)
	{
		...
		m_wndSplitter.SetColumnInfo(0, 400,100);	
		m_wndSplitter.SetColumnInfo(1, rect.Width()-400, 100);	
